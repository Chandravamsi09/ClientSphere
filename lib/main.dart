...
void main() {
  ...
  final navigationController = NavigationController(CrmDestination.dashboard);

  runApp(ClientSphereApp(
...
class ClientSphereApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final effectiveNav = navigationController ?? NavigationController();

    return ThemeScope(
      controller: themeController,
      child: NavigationScope(
        controller: effectiveNav,
          ...
          builder: (context, themeMode, _) {
            return MaterialApp(
              ...
              home: AppShell(
                controller: effectiveNav,
                moduleBuilders: {
                  CrmDestination.dashboard: (_) =>
                      const FoundationShowcaseScreen(),
                },
              ),
            );
          },
              ...
              Container(
                ...
                child: switch (_statePreviewMode) {
                  _StatePreviewMode.empty => const AppEmptyState(
                      ...
                      description:
                          'Closed-won deals will appear in this pipeline view.',
                  ...
                  _StatePreviewMode.error => const AppErrorState(
                      title: 'Sync Failed',
                      message:
                          'Unable to reach the CRM server. Check network connection.',
                      onRetry: null,
                    ),
                },
              ),
